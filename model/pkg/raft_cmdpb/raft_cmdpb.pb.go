...
func (m *Command) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateReq != nil {
		...
		n31, err := m.UpdateReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
	...
	if m.TxnPrepareReq != nil {
		...
		n32, err := m.TxnPrepareReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.TxnDecideReq != nil {
		...
		n33, err := m.TxnDecideReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.TxnClearupReq != nil {
		...
		n34, err := m.TxnClearupReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *PeerTask) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VerifyEpoch != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.VerifyEpoch.Size()))
		n35, err := m.VerifyEpoch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
