...
func (m *ClusterStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LeaderBalanceRatio != 0 {
		dAtA[i] = 0x59
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.LeaderBalanceRatio))))
	}
	if m.RegionBalanceRatio != 0 {
		dAtA[i] = 0x61
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.RegionBalanceRatio))))
	}
	return i, nil
}
...
func (m *TaskInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UsedTime != 0 {
		dAtA[i] = 0x41
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.UsedTime))))
	}
	if len(m.Describe) > 0 {
		dAtA[i] = 0x4a
		i++
...
func (m *HotSpotStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotalWrittenBytesAsPeer != 0 {
		dAtA[i] = 0x19
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.TotalWrittenBytesAsPeer))))
	}
	...
	if m.TotalWrittenBytesAsLeader != 0 {
		dAtA[i] = 0x29
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.TotalWrittenBytesAsLeader))))
	}
...
func (m *TpStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Min != 0 {
		dAtA[i] = 0x11
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Min))))
	}
	if m.Max != 0 {
		dAtA[i] = 0x19
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Max))))
	}
	if m.Avg != 0 {
		dAtA[i] = 0x21
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Avg))))
	}
	if m.Tp_50 != 0 {
		dAtA[i] = 0x29
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Tp_50))))
	}
	if m.Tp_90 != 0 {
		dAtA[i] = 0x31
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Tp_90))))
	}
	if m.Tp_99 != 0 {
		dAtA[i] = 0x39
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Tp_99))))
	}
	if m.Tp_999 != 0 {
		dAtA[i] = 0x41
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Tp_999))))
	}
	if m.TotalNumber != 0 {
		dAtA[i] = 0x48
		i++
...
func (m *SlowLog) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Lats != 0 {
		dAtA[i] = 0x11
		i++
		i = encodeFixed64Statspb(dAtA, i, uint64(math.Float64bits(float64(m.Lats))))
	}
	return i, nil
}
