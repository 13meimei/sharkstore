...
class TestMsg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tpb.TestMsg) */ {
 public:
  TestMsg();
  virtual ~TestMsg();
  ...
  // @@protoc_insertion_point(class_scope:tpb.TestMsg)
 private:
...
// string message = 1;
inline void TestMsg::clear_message() {
  message_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& TestMsg::message() const {
  // @@protoc_insertion_point(field_get:tpb.TestMsg.message)
  return message_.GetNoArena();
}
inline void TestMsg::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tpb.TestMsg.message)
}
#if LANG_CXX11
inline void TestMsg::set_message(::std::string&& value) {
