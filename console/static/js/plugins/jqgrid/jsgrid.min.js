...
function(a, b, c) {
    ...
    d.prototype = {
        ...
        _initLoadStrategy: function() {
            this._loadStrategy = s(this.loadStrategy, this)
        },
        _initController: function() {
            this._controller = b.extend({},
            t, s(this.controller, this))
        },
        ...
        _createLoadIndicator: function() {
            return s(this.loadIndicator, this, {
        ...
        _createHeader: function() {
            ...
            f = this._header = b("<div>").addClass(this.gridHeaderClass).append(e);
            return f
        },
        _createBody: function() {
            var a = this._content = b("<tbody>"),
            c = this._bodyGrid = b("<table>").addClass(this.tableClass).append(a),
            d = this._body = b("<div>").addClass(this.gridBodyClass).append(c);
            return d
        },
        ...
        _createHeaderRow: function() {
            ...
            return this._eachField(function(c, d) {
                var e = b("<th>").addClass(c.css).appendTo(a).append(c.headerTemplate ? c.headerTemplate() : "").css("width", c.width);
        ...
        _createFilterRow: function() {
            ...
            return this._eachField(function(c) {
                b("<td>").addClass(c.css).appendTo(a).append(c.filterTemplate ? c.filterTemplate() : "").width(c.width)
            }),
            a
        },
        _createInsertRow: function() {
            ...
            return this._eachField(function(c) {
                b("<td>").addClass(c.css).appendTo(a).append(c.insertTemplate ? c.insertTemplate() : "").width(c.width)
            }),
            a
        },
        ...
        _createNoDataRow: function() {
            var a = s(this.noDataContent, this);
        ...
        _getRowClasses: function(a, b) {
            ...
            c.push(s(this.rowClass, this, a, b)),
            c.join(" ")
        },
        ...
        _refreshPager: function() {
            ...
            a.empty(),
            this.paging && this._pagesCount() > 1 ? a.show().append(this._createPager()) : a.hide()
        },
        _createPager: function() {
            var a = this.pageIndex,
            c = this._pagesCount(),
            d = this.pagerFormat.split(" ");
            d = b.map(d, b.proxy(function(d) {
                var e = d;
                return d === l ? e = this._createPages() : d === k ? e = a > 1 ? this._createPagerNavButton(this.pageFirstText, 1) : "": d === m ? e = a > 1 ? this._createPagerNavButton(this.pagePrevText, a - 1) : "": d === n ? e = c > a ? this._createPagerNavButton(this.pageNextText, a + 1) : "": d === o ? e = c > a ? this._createPagerNavButton(this.pageLastText, c) : "": d === p ? e = a: d === q && (e = c),
                b.isArray(e) ? e.concat([" "]) : [e, " "]
            },
            this));
            var e = b("<div>").addClass(this.pagerClass).append(d);
            return e
        },
        ...
        _createPagerNavButton: function(a, b) {
            return this._createPagerButton(a, this.pagerNavButtonClass,
            function() {
                this.openPage(b)
            })
        },
        ...
        _createPagerButton: function(a, c, d) {
            var e = b("<a>").attr("href", r).html(a).on("click", b.proxy(d, this));
        ...
        _refreshWidth: function() {
            var a, b = this._headerGrid,
            c = this._bodyGrid,
            d = this.width,
            e = this._scrollBarWidth();
            "auto" === d && (b.width("auto"), a = b.outerWidth(), d = a + e),
            b.width(""),
            c.width(""),
            this._header.css("padding-right", e),
            this._container.width(d),
            a = b.outerWidth(),
            c.width(a)
        },
        ...
        insertItem: function(a) {
            ...
            this._controllerCall("insertItem", b,
            function(a) {
                a = a || b,
        ...
        _createEditRow: function(a) {
            ...
            return this._eachField(function(d) {
                b("<td>").addClass(d.css).appendTo(c).append(d.editTemplate ? d.editTemplate(a[d.name], a) : "").width(d.width || "auto")
            }),
            c
        },
        ...
        _updateRow: function(a, c) {
            ...
            this._controllerCall("updateItem", d,
            function(b) {
                b = b || d,
                this._finishUpdate(a, b, e),
        ...
        _finishUpdate: function(a, b, c) {
            this.cancelEdit(),
            this.data[c] = b,
            a.replaceWith(this._createRow(b, c))
        },
        ...
        deleteItem: function(b) {
            ...
            if (c.length && (!this.confirmDeleting || a.confirm(s(this.deleteConfirm, this, c.data(g))))) return this._deleteRow(c)
        },
        _deleteRow: function(a) {
            ...
            this._controllerCall("deleteItem", b,
            function() {
...
function(a, b, c) {
    function d(a) {
        ...
        this.textField = "",
        e.call(this, a),
        !a.valueType && this.valueField && this.items.length && (this.valueType = typeof this.items[0][this.valueField])
    }
    var e = a.NumberField;
    d.prototype = new e({
        align: "center",
