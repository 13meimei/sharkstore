    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                } else $(e.cDiv).hide(), d.p.toppager || $(e.hDiv).addClass(k(d.p.styleUI + ".common", "cornertop", !0)); if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
            ...
            return b = $.extend(!0, {
                ...
                if (p.grid && a) {
                    ...
                    var F, G = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px",
                        ...
                        I = $("<form name='FormPost' id='" + v + "' class='FormGrid' onSubmit='return false;' style='width:" + H + ";height:100px;'></form>").data("disabled", !1);
            ...
            return b = $.extend(!0, {
                ...
                if (j.grid && a) {
                    ...
                    var u = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px",
                        ...
                        w = $("<form name='FormPost' id='" + n + "' class='FormGrid' style='width:" + v + ";height:100px;'></form>"),
